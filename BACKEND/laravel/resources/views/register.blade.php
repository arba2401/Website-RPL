...
<head>
    ...
    <title>Booklend.id | Register</title>
    ...
    <div class="container my-3">
        <div class="row mx-5">
            ...
            <form action="/register" method="post" class="ijo-booklend">
                ...
                @enderror
                <div class="form-floating mb-3">
                    <input type="text" name="alamat" id="alamat" class="form-control @error('alamat') is-invalid @enderror" required value="{{ old('alamat') }}" placeholder="alamat">
                        ...
                        <div class="row py-2">
                            ...
                            <div class="col-11 ps-0">
                                <span class="text-start fs-6">Dengan mendaftar, kamu setuju dengan syarat dan ketentuan freelancer Xerabutan. 
                                    Untuk melihat S&K, kunjungi <a href="ipb.link/skxerabutan" class="ijo-booklend" target="_blank">ipb.link/skxerabutan</a></span>
                            </div>
                        </div>
                    </div>
                </h5> --}}
