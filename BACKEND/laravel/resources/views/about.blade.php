...
@section('template')
       <div class="container my-4">
              <div class="row ms-5">
                     <div class="col align-self-center">
                            <h1 class="ijo-booklend fw-bold" style="font-size: 60px">
                                   Apa itu <br>
                                   Xerabutan?
                            </h1>
                            <p class="fs-4">
       ...
       <div class="container my-4">
              <div class="row">
                     <div class="col">
                            <h2 class="ijo-booklend text-center fw-bolder">Visi dan Misi</h2>
                     </div>
              </div>
       </div>
       ...
       <div class="container my-4">
              <div class="row ms-5 me-5">
                     <div class="col border border-2 rounded-4 text-center me-5">
                            <h2 class="ijo-booklend text-center fw-bolder mt-4">Visi</h2>
                            <hr>
                     ...
                     <div class="col border border-2 rounded-4 text-center">
                            <h2 class="ijo-booklend text-center fw-bolder mt-4">Misi</h2>
                            <hr>
       ...
       <div class="container my-5">
              <div class="row">
                     <div class="col text-center">
                            <h2 class="ijo-booklend fw-bold">Logo Kami</h2>
                     </div>
              </div>
              <div class="row">
       ...
       {{-- <div class="container">
              <div class="d-flex justify-content-around mt-5">
                     <div class="card border-ijo-booklend" style="width: 18rem; border: 2px solid;">
