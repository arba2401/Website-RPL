          ...
          <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="/storage/{{ $transaction->agreement }}">Lihat</a></td>
                    {{-- <td>{{ $transaction->user->email }}</td>
                    <td>{{ $transaction->user->nomorhp }}</td> --}}
                    {{-- <td>
                        <a href="/dashboard/categories/{{ $category->slug }}" class="badge bg-ijo-booklend text-decoration-none p-2"><i class="bi bi-eye"></i></a>
